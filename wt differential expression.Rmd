...
ggsave(filename = "outputs/fig1_upset_all_genes.tiff", plot = genome_content_combined, width = 10, height = 5)
...
pca
#ggsave(filename = "outputs/fig6_pca.tiff", width = 7.5, height = 5)
```
...
ggsave("outputs/fig5_phylo_with_shared_DE.tiff", width = 7, height = 5)
