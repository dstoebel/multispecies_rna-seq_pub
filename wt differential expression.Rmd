...
else (tools::md5sum("basic_analysis.RData") == "c8a2afac305759229b7085cfc279a4af"){
...
sig_up_upset <- upset(
  ...
  base_annotations=list(
        'Number of\nupregulated DE genes'=intersection_size(text = aes(size = 2.5)
                                            )
    ),
  labeller = format_species_names,
  sort_sets = "FALSE",
...
sig_down_upset <- upset(
  ...
  min_size = 15,
  set_sizes = FALSE,
  base_annotations = list('Number of\ndownregulated DE genes' = intersection_size(text = aes(size = 2.5))),
  sort_sets = "FALSE",
  labeller = format_species_names,
  themes = upset_modify_themes(
    list(
