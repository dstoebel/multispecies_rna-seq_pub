...
ggsave(filename = "outputs/fig1_upset_all_genes.tiff", plot = genome_content_combined, width = 7, height = 7, compression = "lzw")
...
(species_spec_obs_exp_plot | core_obs_exp_plot) / (core_sig_up_upset | core_sig_down_upset) / (sig_species_each_node + inset_element(phylo, left = .5, right = 1, top = 1, bottom = .3)) +  plot_annotation(tag_levels = list(c("A", "B", "C", "", "D", "", "E")))

ggsave("outputs/fig345.tiff", width = 8, height = 12, compression = "lzw")
